...
- Camera "Tự đi": góc nhìn người thứ nhất bằng phím mũi tên (↑ ↓ đi, ← → quay), đi thử trong cổng như người thật;
  bật tương tác thì màn LED phản ứng theo đúng chỗ mình đang đứng.
